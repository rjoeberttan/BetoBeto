...
function MasterAccount() {
  ...
  const referralLink = "http://localhost:3000/masteragent/account";
          ...
          <form>
            <div className="row">
              <div className="col-sm-12 spacing">
                <label className="form-label">Email: testing@master.com</label>
              </div>
              <div className="col-md-12 spacing">
                <label className="form-label">Username: masteragent </label>
              </div>
              <div className="col-md-12 spacing">
